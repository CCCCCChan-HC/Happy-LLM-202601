...
|------|----------|----------|---------------|
| 前言 | 项目缘起、背景及学习建议 | ✅ 已完成 | [前言笔记](docs/00-前言笔记.md) |
| 第一章 | NLP 基础概念（发展历程、任务分类、文本表示演进） | ✅ 已完成 | [NLP基础笔记](docs/01-NLP基础概念笔记.md) |
| 第二章 | Transformer 架构（注意力机制、Encoder-Decoder、手动搭建） | ☐ 未开始 | - |
